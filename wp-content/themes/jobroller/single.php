			...
			<div class="socialwrap">
				...
				<div class="socialleft">
					...
					<ul class="social-ico">
						...
						<li class="rss"><a target="_blank" href="<?php if ( get_option('jr_feedburner_url') <> '' ) { echo get_option('jr_feedburner_url'); } else { echo get_bloginfo_rss('rss2_url'); } ?>?post_type=post"><?php _e('Subscribe to RSS Feed', 'appthemes'); ?></a></li>
						<li class="twitter"><a target="_blank" href="http://www.twitter.com/<?php echo get_option('jr_twitter_id'); ?>"><?php _e('Follow us on Twitter', 'appthemes'); ?></a></li>
