...
<ul class="display_section">
	...
	<li><a href="#specialities" class="noscroll"><?php _e('Speciality', 'appthemes'); ?></a></li>
	<li><a href="#groups" class="noscroll"><?php _e('Group', 'appthemes'); ?></a></li>
</ul>
<div id="browseby" class="tabbed_section"><div class="contents">
    <ul>
		...
		if ($terms) :
			echo '<li><a class="top" href="#open">'.__('Spoken Languages', 'appthemes').'</a> <ul>';
		...
		<li><a class="top" href="<?php echo get_post_type_archive_link('resume'); ?>"><?php _e('View all resumes', 'appthemes'); ?></a></li>
