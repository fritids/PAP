            ...
            <div id="comment-<?php comment_ID(); ?>" class="comment_container">
                ...
                <div class="comment-text">
                    ...
                    <?php if ($comment->comment_approved == '0') : ?>
                            ...
                            <p class="meta"><em><?php _e('Your comment is awaiting approval','appthemes'); ?></em></p>

                    <?php else : ?>

                            <p class="meta">
                                
								<a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php _e('Comment','appthemes'); ?></a>
								<?php _e('made by','appthemes'); ?> <strong><?php comment_author_link(); ?></strong>
								<?php _e('on','appthemes'); ?> <?php echo get_comment_date('M jS Y'); ?> at <?php echo get_comment_time(); ?>: <?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
								<?php edit_comment_link(__('(Edit)', 'appthemes'),'  ','') ?>
