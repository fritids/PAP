		...
		<?php if (have_posts()) : ?>
			...
			<?php while (have_posts()) : the_post(); ?>
				...
				<div class="section_header">
					...
					<div class="date"><strong><?php the_time(__('j M','appthemes')); ?></strong> <span class="year"><?php the_time(__('Y','appthemes')); ?></span></div>
				...
				<ul class="section_footer" style="display:none;">
					...
					<?php if ($url = get_post_meta($post->ID, 'job_url', true)) : ?>
						...
						?> target="_blank" rel="nofollow"><?php _e('View &amp; Apply Online','appthemes'); ?></a></li>
					<?php else :?>
					...
					<?php if (is_user_logged_in() && current_user_can('can_submit_resume')) : $starred = (array) get_user_meta(get_current_user_id(), '_starred_jobs', true); ?>
						<?php if (!in_array($post->ID, $starred)) : ?>
							<li class="star"><a href="<?php echo add_query_arg( 'star', 'true', get_permalink() ); ?>" class="star"><?php _e('Star Job','appthemes'); ?></a></li>
						<?php else : ?>
							<li class="star"><a href="<?php echo add_query_arg( 'star', 'false', get_permalink() ); ?>" class="star"><?php _e('Un-star Job','appthemes'); ?></a></li>
						<?php endif; ?>
					<?php endif; ?>
					
					<li class="print"><a href="javascript:window.print();"><?php _e('Print Job','appthemes'); ?></a></li>
					
					<?php if (get_post_meta($post->ID, '_jr_geo_longitude', true) && get_post_meta($post->ID, '_jr_geo_latitude', true)) : ?><li class="map"><a href="#map" class="toggle_map"><?php _e('View Map','appthemes'); ?></a></li><?php endif; ?>
					
					<?php if(function_exists('selfserv_sexy')) { ?><li class="sexy share"><a href="#share_form" class="share"><?php _e('Share Job','appthemes'); ?></a></li><?php } ?>
